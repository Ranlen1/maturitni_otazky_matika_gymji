...
\\
Příklad: Nechť $f: \mathbb{N} \rightarrow \mathbb{N}$ je zobrazení definované jako $f(x) = 2x$ a $g: \mathbb{N} \rightarrow \mathbb{N}$ je zobrazení definované jako $g(y) = y + 3$. Zapište zobrazení $f$ a $g$ a poté složené zobrazení $g \circ f$. U obou zobrazení určete jen 5 prvních prvků
\\
\\
Řešení: Prvních 5 prvků zobrazení $f$ je f = \{(1, 2), (2, 4), (3, 6), (4, 8)\} a první 4 prvků zobrazení $g$ je g = \{(1, 4), (2, 5), (3, 6), (4, 7)\}. Složené zobrazení $g \circ f$ je definováno jako $g(f(x)) = g(2x) = 2x + 3$. Prvních 5 prvků složeného zobrazení $g \circ f$ je \{(1, 5), (2, 7), (3, 9), (4, 11)\}.
