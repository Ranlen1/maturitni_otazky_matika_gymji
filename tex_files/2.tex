...
\subsection*{Relace}
Relace R nad množinami A a B je libovolná podmnožina kartézského součinu $A \times B $.
...
\begin{itemize}[itemsep = 2pt]
    ...
    \item \textbf{Relace uspořádání} je relace, která je antisymetrická a tranzitivní. Objevuje se například u blah blah blah \dots
\end{itemize}
